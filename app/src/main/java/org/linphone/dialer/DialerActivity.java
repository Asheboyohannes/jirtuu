...
public class DialerActivity extends MainActivity implements AddressText.AddressChangedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinphonePreferences.instance().setHideRemovedProxiesChatRooms(false);
        api = new APICALL();
        ...
        mAddContact.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        intent.putExtra("isdiallerclicked", "yes");
                        intent.putExtra("number", mAddress.getText().toString());
                        ...
                        picker.setListener(
                                new CountryPickerListener() {
                                    ...
                                    public void onSelectCountry(
                                        ...
                                        mAddress.setText(dialCode);
                                        CountryPick.setImageResource(flagDrawableResID);
                                        picker.dismiss();
                                        mAddress.setSelection(
                                                mAddress.getText().toString().length());
                                    }
                                });
        ...
        protected void onPostExecute(String result) {
            if (result == null) {
                ...
                try {
                    ...
                    SideMenuFragment.BalanceTV.setText(BALANCE);
